...
header('X-Frame-Options: SAMEORIGIN');
 ...
 require_once '/var/www/main/config/config.php'; 
...
<head>
	...
	<title>Login - Edifyn Account</title>
...
<link href="<?php echo $hostname; ?>/css/nav.css" rel="stylesheet">
<link href="<?php echo $hostname; ?>/css/footer.css" rel="stylesheet">
<link href="<?php echo $hostname; ?>/css/font.css" rel="stylesheet">
<link href="<?php echo $hostname; ?>/css/normal.css" rel="stylesheet">
<link href="<?php echo $hostname; ?>/css/login.css" rel="stylesheet">
<link href="<?php echo $hostname; ?>/css/app/app-nav.css" rel="stylesheet">



	<script src="<?php echo $jscdn; ?>/vendor/min/jquery-3.1.1.min.js" integrity="sha256-hVVnYaiADRTO2PzUGmuLJr8BLUSjGIZsDYGmIJLv2b8=" crossorigin="anonymous"></script>
...
<?php
 ...
 require_once '/var/www/main/global/nav-one.php';
